...
class InnerBroadcast(Node):
    ...
    @property
    def dsl(self) -> str:
        return f"{type(self).__name__}({self._op!r}, {self._left.dsl}, {self._left_indices}, {self._right.dsl}, {self._right_indices}, {self._out_indices})"

    @property
    def description(self) -> str:
        return f"{type(self).__name__}({self._op!r}, {self.pattern})"
